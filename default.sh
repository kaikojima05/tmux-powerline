...
#
TMUX_POWERLINE_THEME="solarized_dark"
...
#TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR=${TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR:-''}
#TMUX_POWERLINE_DEFAULT_RIGHTSIDE_SEPARATOR=${TMUX_POWERLINE_DEFAULT_RIGHTSIDE_SEPARATOR:-''}
...
if patched_font_in_use; then
	TMUX_POWERLINE_SEG_WEATHER_GLYPH="☀️"
	TMUX_POWERLINE_SEG_CWD_GLYPH="🖿"
	TMUX_POWERLINE_SEG_DATE_GLYPH="⏱"
	TMUX_POWERLINE_SEG_HOSTNAME_GLYPH="👤"
	TMUX_POWERLINE_SEG_VCS_GLYPH="🔧"
else
	TMUX_POWERLINE_SEG_WEATHER_GLYPH="☀"
	TMUX_POWERLINE_SEG_CWD_GLYPH="⏳"
	TMUX_POWERLINE_SEG_DATE_GLYPH="⏰"
	TMUX_POWERLINE_SEG_HOSTNAME_GLYPH="⚑"
	TMUX_POWERLINE_SEG_VCS_GLYPH="⚒"
